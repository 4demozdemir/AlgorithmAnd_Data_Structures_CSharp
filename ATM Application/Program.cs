...
namespace ATM_Application
{
    public class Program
    {
               ...
               //Bunlar ATM üzerinden yapılabilecek temem işlemledir.
              //Para çekme, para yatırma, ödeme yapma vs..İsteğe bağlı olarak genişletilebilir.
           ...
           //Gün sonu alınmak istendiğinde, gün içerisinde yapılan transaction ların logları ve fraud olabilecek yani hatalı giriş denemeleri log gösterilmelidir.
